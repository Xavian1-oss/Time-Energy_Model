...
from layers.FEDformer.Autoformer_EncDec import Encoder, Decoder, EncoderLayer, DecoderLayer, my_Layernorm, \
...
class Model(nn.Module):
    ...
    def forward_original(self, x_enc, x_mark_enc, x_dec, x_mark_dec,
